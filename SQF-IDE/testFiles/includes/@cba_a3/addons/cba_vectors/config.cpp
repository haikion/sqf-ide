...
//'now' is Wed Jul 13 18:00:50 2016 : 'file' last modified on Wed Jul 13 18:00:50 2016
...
class CfgPatches
{
	class cba_vectors
	{
		...
		name = "$STR_cba_vectors_component";
		url = "$STR_CBA_URL";
		units[] = {};
...
class Extended_PreInit_EventHandlers
{
	class cba_vectors
	{
		init = "call compile preProcessFileLineNumbers '\x\cba\addons\vectors\XEH_preInit.sqf'";
	};
};
class CfgFunctions
{
