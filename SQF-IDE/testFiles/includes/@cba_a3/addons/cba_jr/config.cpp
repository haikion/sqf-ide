...
class CfgPatches
{
	class cba_jr
	{
		...
		requiredAddons[] = {"A3_Weapons_F","A3_Weapons_F_Mark","A3_Weapons_F_Exp","CBA_jr_prep","A3_Data_F","A3_Data_F_Mark"};
...
class CfgFunctions
{
	class A3_Bootcamp
	{
		class Inventory
		{
			class compatibleItems
			{
				file = "\x\cba\addons\jr\fnc_compatibleItems.sqf";
			};
		};
	};
	class CBA
