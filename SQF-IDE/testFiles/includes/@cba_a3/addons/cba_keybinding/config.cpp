...
//'now' is Wed Jul 13 18:00:40 2016 : 'file' last modified on Wed Jul 13 18:00:40 2016
//http://dev-heaven.net/projects/list_files/mikero-pbodll
////////////////////////////////////////////////////////////////////

#define _ARMA_

//Class cba_keybinding : config.bin{
class CfgPatches
{
	class cba_keybinding
	{
		author = "$STR_CBA_Author";
		name = "$STR_cba_keybinding_component";
		url = "$STR_CBA_URL";
		units[] = {};
...
class Extended_PreInit_EventHandlers
{
	class cba_keybinding
	{
		init = "call compile preProcessFileLineNumbers '\x\cba\addons\keybinding\XEH_preInit.sqf'";
	};
};
class Extended_DisplayLoad_EventHandlers
{
	...
	{
		cba_keybinding = "_this call compile preProcessFileLineNumbers '\x\cba\addons\keybinding\XEH_configureDisplayLoad.sqf'";
	};
};
class CfgFunctions
{
...
class RscDisplayConfigure
{
	class controls
	{
		...
		{
			idc = 4302;
			text = "$STR_cba_keybinding_configureAddons";
